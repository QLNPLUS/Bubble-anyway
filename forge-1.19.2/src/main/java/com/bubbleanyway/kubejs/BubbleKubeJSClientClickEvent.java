...
/** KubeJS-friendly view of a client-side bubble click. */
public final class BubbleKubeJSClientClickEvent {
    ...
    public LocalPlayer getPlayer() { return source.player(); }
    ...
    public BubbleClientClickEvent getSource() { return source; }
