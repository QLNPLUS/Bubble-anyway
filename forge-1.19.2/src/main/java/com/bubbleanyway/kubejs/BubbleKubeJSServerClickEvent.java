...
public final class BubbleKubeJSServerClickEvent {
    ...
    public ServerPlayer getPlayer() { return source.player(); }
    ...
    public void tell(String message) {
        ...
        if (player != null) player.sendSystemMessage(Component.literal(message == null ? "" : message));
    }
    public boolean isCanceled() { return source.isCanceled(); }
    public void setCanceled(boolean canceled) { source.setCanceled(canceled); }
    public void cancel() { setCanceled(true); }
    public BubbleServerClickEvent getSource() { return source; }
