...
/** Fired after a server validates a click on a bubble control. */
@Cancelable
public final class BubbleServerClickEvent extends Event {
    ...
    /** Sends a plain chat message through the player-safe KubeJS event API. */
