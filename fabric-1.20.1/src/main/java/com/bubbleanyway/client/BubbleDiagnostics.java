...
public final class BubbleDiagnostics {
    ...
    private static final String LOADER = "Fabric 1.20.1";
    ...
    private static void runToastProbe(MinecraftClient client) {
        ...
        toastProbeSent = true;
        Identifier id = Identifier.of("bubble_anyway", "diagnostic/fabric_1201");
        Advancement advancement = Advancement.Builder.createUntelemetered()
                .display(Items.GRASS_BLOCK, Text.literal("Bubble Anyway diagnostic"),
                        Text.literal("Synthetic Fabric 1.20.1 toast"), null,
                        AdvancementFrame.TASK, true, true, false)
                .build(id);
        client.getToastManager().add(new AdvancementToast(advancement));
