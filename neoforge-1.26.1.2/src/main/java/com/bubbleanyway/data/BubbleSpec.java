...
public final class BubbleSpec {
    ...
    public BubbleSpec(
            String id, String text, String iconId, IconType iconType, List<TextPart> textParts,
            int iconSize, int iconGap, int iconOffsetX, int iconOffsetY,
            int textOffsetX, int textOffsetY, int textColor, int backgroundColor,
            String backgroundTexture, int backgroundBorder, int backgroundGuide,
            String sound, float soundVolume, float soundPitch,
            int x, int y, int width, int height, int maxWidth, int padding, int lineSpacing,
            TextAlignment textAlignment, int duration, int fadeIn, int fadeOut,
            int slideIn, int slideOut, int priority, float scale,
            boolean bold, boolean italic, boolean underlined, boolean strikethrough,
            boolean obfuscated, boolean shadow, boolean replace, boolean remove,
            Anchor anchor, Animation animation) {
        this(id, text, iconId, iconType, textParts, iconSize, iconGap,
                iconOffsetX, iconOffsetY, textOffsetX, textOffsetY, textColor, backgroundColor,
                backgroundTexture, backgroundBorder, backgroundGuide, sound, soundVolume, soundPitch,
                x, y, width, height, maxWidth, padding, textAlignment, duration, fadeIn, fadeOut,
                slideIn, slideOut, priority, scale, bold, italic, underlined, strikethrough,
                obfuscated, shadow, replace, anchor, animation, lineSpacing, remove);
    }
