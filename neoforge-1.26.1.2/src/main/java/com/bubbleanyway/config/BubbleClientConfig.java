...
public final class BubbleClientConfig {
    ...
    private static final ModConfigSpec.ConfigValue<String> FALLBACK;
    private static final ModConfigSpec.BooleanValue ADVANCEMENT_ENABLED;
    private static final ModConfigSpec.ConfigValue<String> ADVANCEMENT_TASK_THEME;
    private static final ModConfigSpec.ConfigValue<String> ADVANCEMENT_GOAL_THEME;
    private static final ModConfigSpec.ConfigValue<String> ADVANCEMENT_CHALLENGE_THEME;
    private static final ModConfigSpec.BooleanValue RECIPE_ENABLED;
    private static final ModConfigSpec.ConfigValue<String> RECIPE_THEME;
    private static final ModConfigSpec.BooleanValue FTB_QUESTS_ENABLED;
    private static final ModConfigSpec.ConfigValue<String> FTB_COMPLETION_THEME;
    private static final ModConfigSpec.ConfigValue<String> FTB_REWARD_THEME;
    private static final ModConfigSpec.BooleanValue DIAGNOSTICS_ENABLED;
    private static final ModConfigSpec.BooleanValue DIAGNOSTIC_TEST_BUBBLE;
    ...
    public static void register(ModContainer container) {
        container.registerConfig(ModConfig.Type.CLIENT, SPEC, CONFIG_FILE);
    }
